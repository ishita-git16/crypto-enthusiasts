...
async function main() {
    ...
    // console.log(bitcoinRaw.length);
    // console.log(ethereumRaw.length);
    // console.log(polkadotRaw.length);
    // console.log(cosmosRaw.length);
    ...
    commitChart(bitcoinRaw, ethereumRaw, polkadotRaw, cosmosRaw);
}
