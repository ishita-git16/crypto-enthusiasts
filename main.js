...
const obj = await getCryptoData("https://api.github.com/repos/bitcoin/bitcoin/stats/contributors");

// console.log(obj.following_url);

// console.log(moment());
var weeksArr = obj[0].weeks;
var monthlyCommits = [];
...
obj[0].weeks.forEach(element => {
    console.log(`${new Date(element.w*1000).getMonth()}`);
    // console.log(element.w/100);
});
