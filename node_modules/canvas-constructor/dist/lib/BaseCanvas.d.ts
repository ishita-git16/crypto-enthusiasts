...
export declare abstract class BaseCanvas<CanvasType extends BaseCanvasElement = HTMLCanvasElement, ContextType extends CanvasRenderingContext2D = CanvasRenderingContext2D, ImageType extends Parameters<ContextType['drawImage']>[0] = Parameters<ContextType['drawImage']>[0], TextMetricsType extends ReturnType<ContextType['measureText']> = ReturnType<ContextType['measureText']>> {
    /**
     ...
     * </script>
     */
    constructor(canvas: CanvasType, context?: ContextType);
    /**
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/getImageData
     */
    getImageData(callback: (this: this, data: ImageData, canvas: this) => unknown): this;
    /**
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/getImageData
     */
    getImageData(x: number, y: number, width: number, height: number, callback: (this: this, data: ImageData, canvas: this) => unknown): this;
    /**
     ...
     */
    measureText(text: string): TextMetricsType;
    /**
     * Measure a text's width given a string.
     * @param text The text to measure.
     ...
     *     .toBuffer(); // Returns a Buffer
     */
    measureText(text: string, callback: (this: this, measurement: TextMetricsType, canvas: this) => unknown): this;
    /**
     ...
     */
    printImage(image: ImageType, dx: number, dy: number): this;
    /**
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage
     */
    printImage(image: ImageType, dx: number, dy: number, dw: number, dh: number): this;
    /**
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage
     */
    printImage(image: ImageType, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number): this;
    /**
     * Add a round image.
     ...
     */
    printCircularImage(imageOrBuffer: ImageType, x: number, y: number, radius: number, options?: PrintCircularOptions): this;
    /**
     * Add a beveled image.
     * @param imageOrBuffer The image.
     * @param x The position x to start drawing the element.
     ...
     */
    printRoundedImage(imageOrBuffer: ImageType, x: number, y: number, width: number, height: number, radius: BeveledRadiusOptions | number): this;
    /**
     ...
     */
    createPattern(image: ImageType, repetition: PatternRepeat): CanvasPattern;
    /**
     * Creates a pattern using the specified image. It repeats the source in the directions specified by the repetition
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/createPattern
     */
    createPattern(image: ImageType, repetition: PatternRepeat, callback: (this: this, pattern: CanvasPattern, canvas: this) => unknown): this;
    /**
     * Creates a pattern using the specified image. It repeats the source in the directions specified by the repetition
     ...
     * @see https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/createPattern
     */
    printPattern(image: ImageType, repetition: PatternRepeat): this;
    /**
     ...
     *     .toBuffer(); // Returns a Buffer
     */
    wrapText(text: string, wrapWidth: number, callback: (this: this, text: string, canvas: this) => unknown): this;
    protected parseFont(font: string): readonly [string] | readonly [string, number, string];
    protected resolveCircularCoordinates(imageOrBuffer: ImageType, x: number, y: number, radius: number, fit: NonNullable<PrintCircularOptions['fit']>): ResolvedCircularCoordinates;
}
...
export {};
//# sourceMappingURL=BaseCanvas.d.ts.map