...
/// <reference lib="dom" />
import { Canvas as SkiaCanvas, CanvasRenderingContext2D as SkiaCanvasRenderingContext2D, FontLibrary, FontVariant, Image as SkiaImage, loadImage, Path2D } from 'skia-canvas';
...
export declare class Canvas extends BaseCanvas<SkiaCanvas, SkiaCanvasRenderingContext2D> {
    constructor(canvas: SkiaCanvas, context: SkiaCanvasRenderingContext2D);
    constructor(width: number, height: number);
    /**
     * Returns the pages created with {@link SkiaCanvas.newPage}.
     */
    getPages(): readonly SkiaCanvasRenderingContext2D[];
    /**
     * Calls the callback with the pages created with {@link SkiaCanvas.newPage}, and returns itself.
     * @param cb The callback to be called.
     */
    getPages(cb: (pages: readonly SkiaCanvasRenderingContext2D[]) => void): this;
    /**
     ...
     */
    newPage(width: number, height: number): Canvas;
    /**
     ...
     */
    getFontVariant(): FontVariantString;
    /**
     ...
     * @param cb The callback to be called.
     */
    getFontVariant(cb: (fontVariant: FontVariantString) => void): this;
    /**
     ...
     */
    getTextTracking(): number;
    /**
     * Calls the callback with the text tracking property, and returns itself.
     * @param cb The callback to be called.
     * @see {@link SkiaCanvas.setTextTracking}
     */
    getTextTracking(cb: (textTracking: number) => void): this;
    /**
     ...
     * @see {@link SkiaCanvas.setTextWrap}
     */
    getTextWrap(cb: (textWrap: boolean) => void): this;
    /**
     ...
     * @param options The render options.
     */
    toBuffer(format: RenderImageFormat, options?: RenderOptions): Buffer | Promise<Buffer>;
    /**
...
export declare function registerFont(familyName: string, fontPaths: ReadonlyArray<string>): FontVariant[];
export declare function registerFont(fontPaths: ReadonlyArray<string>): FontVariant[];
export declare function registerFont(families: Record<string, ReadonlyArray<string> | string>): Record<string, FontVariant[] | FontVariant>;
